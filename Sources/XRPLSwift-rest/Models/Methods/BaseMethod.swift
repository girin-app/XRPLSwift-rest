...
public class BaseRequest<R: Request>: Codable, Equatable {
    ...
    public init(id: Int? = nil, method: String? = nil, apiVersion: Int? = nil, params: [R]? = nil) {
        self.id = id
        self.method = method
    ...
    public init(_ json: [String: AnyObject]) throws {
        ...
        self.id = decoded.id
        self.method = decoded.method
        self.apiVersion = decoded.apiVersion
        self.params = decoded.params
    }
